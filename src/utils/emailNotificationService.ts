    ...
    htmlContent: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        <div style="background: #0F1428; padding: 20px; text-align: center;">
          <h2 style="color: #D64062; margin: 0; font-size: 20px; font-weight: 800;">FORYN DESIGN & BUILD</h2>
          <p style="color: #94a3b8; margin: 4px 0 0 0; font-size: 12px;">Transactional Payout Notification</p>
        </div>
        <div style="padding: 24px;">
          <h3 style="color: #0F1428; margin-top: 0;">Payment Milestone Approved by Site PM</h3>
          ...
          <div style="background: #FDFDFD; border: 1px solid #cbd5e1; border-radius: 8px; padding: 16px; margin: 20px 0;">
            <div style="font-size: 12px; color: #64748b; text-transform: uppercase; font-weight: bold;">Approved Payout Details</div>
            <div style="font-size: 24px; font-weight: 900; color: #D64062; margin: 8px 0;">₹2,50,000</div>
            <div style="font-size: 13px; color: #0F1428;">+18% GST: ₹45,000 | <strong>Net Payable: ₹2,95,000</strong></div>
  ...
  },
  {
    ...
    htmlContent: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 24px;">
          <h3 style="color: #0F1428; margin-top: 0;">Project Lead Status Updated</h3>
          ...
          <div style="background: #FDFDFD; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin: 20px 0;">
            <div style="font-size: 12px; color: #0F1428; text-transform: uppercase; font-weight: bold;">New Stage</div>
            <div style="font-size: 20px; font-weight: 800; color: #D64062; margin: 4px 0;">Call Done</div>
            <div style="font-size: 13px; color: #475569; margin-top: 6px;">Assigned Sales Manager: Rishabh Bhardwaj | Design Lead: Anjali Sharma</div>
          </div>
  ...
  if (params.templateType === 'vendor_payment_approval') {
    ...
    bodyHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 24px;">
          <h3 style="color: #0F1428; margin-top: 0;">Milestone Approved by Project Manager</h3>
          ...
          <div style="background: #FDFDFD; border: 1px solid #cbd5e1; border-radius: 8px; padding: 16px; margin: 20px 0;">
            ...
            <div style="font-size: 24px; font-weight: 900; color: #D64062; margin: 8px 0;">₹${gross.toLocaleString('en-IN')}</div>
            <div style="font-size: 13px; color: #0F1428;">+18% GST: ₹${gst.toLocaleString('en-IN')} | <strong>Net Payable: ₹${net.toLocaleString('en-IN')}</strong></div>
          </div>
    ...
    bodyHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        <div style="background: #0F1428; padding: 20px; text-align: center;">
          <h2 style="color: #D64062; margin: 0; font-size: 20px; font-weight: 800;">RTGS DISBURSEMENT CONFIRMED</h2>
          <p style="color: #94a3b8; margin: 4px 0 0 0; font-size: 12px;">Foryn Studio Finance & Banking Gateway</p>
        </div>
        <div style="padding: 24px;">
          <h3 style="color: #0F1428; margin-top: 0;">Funds Disbursed to Vendor Account</h3>
          <p style="color: #475569; font-size: 14px;">Dear <strong>${params.recipientName}</strong>,</p>
          ...
          <div style="background: #FDFDFD; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin: 20px 0;">
            <div style="font-size: 12px; color: #0F1428; text-transform: uppercase; font-weight: bold;">Disbursed Amount</div>
            <div style="font-size: 24px; font-weight: 900; color: #D64062; margin: 8px 0;">₹${(params.data.amount || 0).toLocaleString('en-IN')}</div>
            <div style="font-size: 13px; color: #0F1428; font-family: monospace;">Bank Reference Number: <strong>${params.data.paymentRef || 'HDFC-RTGS-9901823'}</strong></div>
          </div>
        </div>
        <div style="background: #f1f5f9; padding: 16px; text-align: center; font-size: 11px; color: #64748b;">
    ...
    bodyHtml = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 12px; overflow: hidden;">
        ...
        <div style="padding: 24px;">
          <h3 style="color: #0F1428; margin-top: 0;">${params.subject}</h3>
          ...
          <div style="background: #FDFDFD; border: 1px solid #e2e8f0; border-radius: 8px; padding: 16px; margin: 20px 0;">
            <div style="font-size: 18px; font-weight: 800; color: #D64062;">${params.data.newStatus || 'Updated'}</div>
            ${params.data.notes ? `<div style="font-size: 12px; color: #64748b; margin-top: 6px;">Notes: ${params.data.notes}</div>` : ''}
          </div>
        </div>
        <div style="background: #f1f5f9; padding: 16px; text-align: center; font-size: 11px; color: #64748b;">
