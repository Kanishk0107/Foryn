    ...
    <div className="fixed inset-0 z-50 bg-slate-950/70 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto">
      <div className="w-full max-w-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl relative my-8 max-h-[85vh] flex flex-col">
        ...
        <div className="flex items-center gap-3 mb-4 shrink-0">
          <FileText className="w-6 h-6 text-[#F62440]" />
          <div>
            <h2 className="text-xl font-black text-slate-900 dark:text-white">Terms of Service</h2>
            <p className="text-xs text-slate-500 font-mono">Foryn Platform Terms — v2.4 (2026)</p>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto pr-2 space-y-4 text-xs text-slate-600 dark:text-slate-300 leading-relaxed font-sans">
          <section className="space-y-2">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">1. Workstation License</h3>
            <p>
              By creating a Foryn Studio account, you are granted a enterprise workstation license to create, edit, cost, and execute 3D CAD interior projects.
            </p>
          </section>

          <section className="space-y-2">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">2. User Account Hierarchy</h3>
            <p>
          ...
          <section className="space-y-2">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">3. BOQ Calculations & GST Compliance</h3>
            <p>
          ...
          <section className="space-y-2">
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">4. Registered Business Address</h3>
            <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-[11px] font-mono text-slate-700 dark:text-slate-300">
              <p className="font-bold">Pentagram Living Pvt. Ltd. / Foryn Technologies</p>
