    ...
    <div className="flex items-center gap-3 p-2 h-full">
      ...
      >
        <div className="shrink-0">
          <HugeiconsIcon icon={Search01Icon} className="w-6 h-6 text-gray-800" />
        </div>
        ...
        >
          <input
            type="text"
            placeholder="Search"
            className="border-0 outline-none bg-transparent text-lg text-slate-900 focus-visible:ring-0 focus-visible:ring-offset-0 w-full"
        ...
        >
            ...
            <div className="flex items-center gap-2 px-[6px]">
              {TABS.map((tab) => (
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-3 rounded-[3rem] transition-colors relative cursor-pointer ${
          ...
          >
            <button onClick={() => setIsSearchExpanded(false)} className="shrink-0 cursor-pointer">
              <HugeiconsIcon icon={MultiplicationSignIcon} className="w-6 h-6 text-gray-800" />
            </button>
          </motion.div>
        </motion.div>
      </motion.div>
