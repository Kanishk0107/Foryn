  ...
  return (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-xs space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className="px-2.5 py-1 rounded-full bg-amber-100 dark:bg-amber-950 text-amber-800 dark:text-amber-300 text-[10px] font-mono font-bold">
          LIVE METRICS
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 pt-2">
        <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800">
          ...
          <div className="text-[10px] text-emerald-600 font-semibold mt-1">↑ +2 this month</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800">
          ...
          <div className="text-[10px] text-emerald-600 font-semibold mt-1">18% GST Accounted</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800">
          ...
          <div className="text-[10px] text-amber-600 font-semibold mt-1">Stage 14 active</div>
        </div>
        ...
        <div className="p-3.5 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200/60 dark:border-slate-800">
          ...
          <div className="text-[10px] text-cyan-600 font-semibold mt-1">GPU Cluster Ready</div>
        </div>
      </div>
    </div>
  );
